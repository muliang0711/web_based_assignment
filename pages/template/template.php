...
<p>当您将原始代码复制并粘贴到此处时，可能会遇到一些困难。您可能需要修改原本的 CSS（甚至稍微调整一下结构），以确保它能够在此环境中良好展示。请注意，您在此处编写的内容实际上<b>被包含在一个 <code>&lt;main&gt;</code> 元素中</b>，这个元素本身已有自己的 CSS（定义在 <code>/css/app.css</code> 中）。若有需要，您可以覆盖这些 CSS 以适应您的需求（比如使用 <code>margin: -100px;</code> 让一个 element 不受 <code>&lt;main&gt;</code> 已有的 left padding 和 right padding 影响）。</p>

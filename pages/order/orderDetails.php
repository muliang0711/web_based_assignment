<?php 
    ...
    //messages for email
    if($order->notify == "1"){
        $msg1 = "You'll Be Notified On Updates";
    }
    else {
        $msg1 = "Sign Up for Email Notifications";
...
<div class="container1">
    ...
    <div class="email-container">
        ...
        <?php if($order->notify != "1"):?>
            ...
            <button class="email-button" data-id="<?= $order->orderId ?>">
        ...
        <?php else:?>
            <p>Email will be sent directly to <span style="color: var(--seclessImportant);font-weight: 500;"><?= $order->email ?></span>.</p>
            <button class="unsubscribe-email-button" data-id="<?= $order->orderId ?>">

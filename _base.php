  ...
  <div class='container' style='display: block; margin: 0 auto !important; max-width: 580px; padding: 50px; width: 100%; box-sizing: border-box;'>
    ...
    <header style='margin-bottom: 30px; box-sizing: border-box;'>
      <a href='$home_url' style='box-sizing: border-box;'>
        <div class='top-nav-store-logo' style='font-size: 1.5em; font-weight: bold; color: #888;'>
            The<span style='background: linear-gradient(90deg, rgb(122, 122, 255), rgb(148, 253, 148)); background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;'>Shuttle</span>Store
            <svg fill='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' style='height:1em; transform:rotate(45deg);'>
